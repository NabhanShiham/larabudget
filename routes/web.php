...
Route::post('/chat/send', [\App\Http\Controllers\larabudget\ChatController::class, 'store'])->name('chat.send');

Route::get('/getUser', [\App\Http\Controllers\larabudget\UserProfileController::class, 'getUser'])->name('get.user');
